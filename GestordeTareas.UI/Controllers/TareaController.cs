...
namespace GestordeTareas.UI.Controllers
{
    ...
    public class TareaController : Controller
    {
        ...
        public async Task<ActionResult> Details(int id)
        {
            ...
            {
                tarea.Prioridad.Nombre = tarea.Prioridad.Nombre;
            }
            if (tarea.EstadoTarea != null)
            {
                tarea.EstadoTarea.Nombre = tarea.EstadoTarea.Nombre;
            }
            if (tarea.Proyecto != null)
            {
                // Asumiendo que la propiedad de navegación tiene un campo "Titulo" de tipo string
                tarea.Proyecto.Titulo = tarea.Proyecto.Titulo;
            }
